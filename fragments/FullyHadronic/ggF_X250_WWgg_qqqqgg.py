...
generator = cms.EDFilter("Pythia8HadronizerFilter",
        ...
        processParameters = cms.vstring(
            ...
            '24:onIfAny = 1 2 3 4', # Add W->enu, W->munu, (no tau decay). Add W->qq decays without b quarks 
            ...
            'ResonanceDecayFilter:daughters = 1,1,1,1,22,22', # qq,lnu,gg. Technically tau neutrinos are allowed in the final state, but there is no way to produce them here
          ),
